...
<div>
    <div class="container" id="tamanhoContainer" style="margin-top: 40px; width: 500px;">
        ...
        <form action="_salvar_alteracao_categoria.php" method="post" style="margin-top: 20px;">
        <?php
        ...
        ?>
            ...
            <div class="form-group">
                <label>Nome</label>
                <input type="text" class="form-control" name="nome_cat" value="<?php echo $nome_cat; ?>">
            </div>
            <div class="form-group">
                <label>Descrição</label>
                <textarea type="text" class="form-control" name="desc_cat" rows="3"><?php echo $desc_cat; ?></textarea>
            </div>
