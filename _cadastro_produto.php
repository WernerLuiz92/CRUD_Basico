    ...
    <div class="container" id="tamanhoContainer" style="margin-top: 40px;">
        <center>
            <div class="container" style="width: 500px;">
                ...
                <a class="btn btn-sm btn-primary" href="_listar_produto.php" role="button"><i class="fas fa-list"></i>&nbsp;Listar
                    Produtos</a>
            </div>
        ...
        <form action="_inserir_produto.php" method="post" style="margin-top: 20px;">
            ...
            <div class="botoes" style="text-align: right; width: 49%; float: right;">
                <a class="btn btn-danger btn-sm" href="_cadastro_produto.php" role="button"><i
