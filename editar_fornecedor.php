...
<div>
    <div class="container" id="tamanhoContainer" style="margin-top: 40px; width: 500px;">
        ...
        <form action="_salvar_alteracao_fornecedor.php" method="post" style="margin-top: 20px;">
        <?php
        ...
        ?>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="razsoc_forn" value="<?php echo $razsoc_forn ?>">
            </div>
            <div class="form-group">
                <label>CNPJ</label>
                <input type="text" class="form-control" name="cnpj_forn" value="<?php echo $cnpj_forn ?>">
            </div>
            <div class="form-group">
                <label>Nome fantasia</label>
                <input type="text" class="form-control" name="nome_forn" value="<?php echo $nome_forn ?>">
            </div>
            <div class="form-group">
                <label>Cidade</label>
                <input type="text" class="form-control" name="cidade_forn" value="<?php echo $cidade_forn ?>">
            </div>
            <div class="form-group">
                <label>Telefone de Contato</label>
                <input type="text" class="form-control" name="tel_forn" value="<?php echo $tel_forn ?>">
            </div>
            <div class="form-group">
                <label>E-mail</label>
                <input type="email" class="form-control" name="email_forn" value="<?php echo $email_forn ?>">
            </div>            
